...
for TENSOR_PARALLEL_SIZE in ${TENSOR_PARALLEL_SIZES[@]}; do
    ...
    setsid bash serve-deepseek-r1.sh 2>&1 &
    SERVING_PID=$!                        
        ...
        for WORKLOAD_INTENSITY in ${WORKLOAD_INTENSITIES[@]}; do
            ...
            for ARRIVAL_RATE in ${ARRIVAL_RATES[@]}; do
                ...
                for ITERATION in $(seq 1 ${ITERATIONS}); do
                    ...
                    OUTPUT_PREFIX="deepseek-r1_tp${TENSOR_PARALLEL_SIZE}_${WORKLOAD_TASK}_${WORKLOAD_INTENSITY}_rate${ARRIVAL_RATE}_iter${ITERATION}_${DATE_TIME}"
