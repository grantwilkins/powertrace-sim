...
for TENSOR_PARALLEL_SIZE in ${TENSOR_PARALLEL_SIZES[@]}; do
    ...
    setsid bash serve-deepseek-r1-distill-8b.sh 2>&1 &
    SERVING_PID=$!
    ...
    for ARRIVAL_RATE in ${ARRIVAL_RATES[@]}; do
        ...
        for ITERATION in $(seq 1 ${ITERATIONS}); do
            ...
            OUTPUT_PREFIX="deepseek-r1-distill-8b_tp${TENSOR_PARALLEL_SIZE}_${WORKLOAD_TASK}_${WORKLOAD_INTENSITY}_rate${ARRIVAL_RATE}_iter${ITERATION}_${DATE_TIME}"
