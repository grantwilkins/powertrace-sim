...
def main(args: argparse.Namespace):
    ...
    if args.save_result or args.append_result:
        ...
        result_json["tensor_parallel_size"] = args.tensor_parallel_size
        ...
        file_name = f"{backend}-{args.request_rate}qps{max_concurrency_str}-tp{tp}-{base_model_id}-{current_dt}.json"  # noqa
