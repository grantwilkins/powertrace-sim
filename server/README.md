...
The server scripts are typically invoked by the job scripts in `job-scripts/`:

```bash
# This will start the server, run benchmarks, and collect data
bash job-scripts/llama-3-8b.sh
```
...
- [job-scripts/README.md](../job-scripts/README.md) - Automated benchmarking scripts
- [client/README.md](../client/README.MD) - Benchmark client documentation
