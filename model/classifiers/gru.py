...
class GRUClassifier(nn.Module):
    ...
    Features:
    - Multi-layer bidirectional GRU with locked dropout
    - LayerNorm for input normalization
    - Deep classification head with dropout
    - Proper weight initialization (orthogonal for RNN, Xavier for linear)
    """
