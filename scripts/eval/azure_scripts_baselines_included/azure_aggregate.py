#!/usr/bin/env python3
"""
Isolated Azure pipeline: aggregate per-method node traces to rack/row/site levels.
...
def main() -> None:
    ...
    parser = argparse.ArgumentParser(description="Aggregate isolated Azure node traces by method.")
    ...
    print("=" * 72)
    print("Azure Hierarchical Aggregation (Baselines Included)")
    print("=" * 72)
