...
# Add profiling/client directory to path for imports
...
def build_preset_stats(task, level, preset, tokenizer, num_requests=20000, seed=42):
...
def main():
    ...
    for task in tasks:
        for level in levels:
            ...
            stats = build_preset_stats(task, level, preset, tokenizer)
